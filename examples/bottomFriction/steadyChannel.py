...
def run_steady_channel(layers=25, gls_closure='k-omega',
                       stability_func='Canuto B',
                       fast_convergence=False, verify=True,
                       iterate=True, load_export_ix=None):
    outputdir = 'outputs'
    # set mesh resolution
    dx = 2500.0
    depth = 15.0
...
if __name__ == '__main__':
    run_steady_channel(250, gls_closure='Generic Lenght Scale', stability_func='Canuto A')
